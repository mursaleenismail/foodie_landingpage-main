      ...
      <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
        ...
        {pagesArr.map((x, index) => (
          <ListItem key={index} disablePadding>
            <ListItemButton><ListItemText primary={x.name} />
            </ListItemButton>
          </ListItem>
        ))}
      </List>
 ...
 >
  ...
  boxShadow:"none"
        ...
        <StyledToolbar >
          ...
          <Image  style={{paddingTop:"7px"}}  src={Logo2} width={75} height={30} alt="" />
          </Stack>
        ...
        <IconButton aria-label="open drawer"
          ...
          {pagesArr.map((page, index) => (
              <Button key={index} sx={{ marginRight: '8px',
              "&:hover": {
                backgroundColor: "#ccff90",
                fontSize: 14,
              },
              }}>
            <span style={{ fontSize:"15px",fontWeight:550,color:"black",marginRight: '4px',
